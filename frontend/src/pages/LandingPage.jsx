...
const FeatureCard = ({ icon: Icon, title, description }) => (
  <CardSpotlight
    className="p-6 rounded-2xl border border-white/10 backdrop-blur-md hover:scale-105 transition-all duration-300 group relative z-10"
    color="#6366f1"
  >
...
const LandingPage = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-transparent text-white selection:bg-indigo-500/30">
        ...
        <main className="flex-1">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="text-center mb-20">
                ...
                <p className="text-slate-400 max-w-2xl mx-auto">
                  Built for performance, privacy, and precision. We combine the
                  power of large language models with local retrieval augmented
                  generation.
                </p>
              </div>
          ...
          <section className="py-32 px-4 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <Link
                to="/chat"
                className="inline-block px-10 py-5 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full font-bold text-xl text-white shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
              >
                Get Started Now
              </Link>
            </div>
